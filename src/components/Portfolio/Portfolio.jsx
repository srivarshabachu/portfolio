    ...
    className={`paddings ${css.wrapper}`}>
      ...
      <div className={`innerWidth flexCenter ${css.container}`}>
        ...
        <div className={`flexCenter ${css.showCase}`}>
          ...
          <motion.img variants={fadeIn("up", "tween", .9, .6)} src="./bloodlink.png" alt="project" />
          <motion.img variants={fadeIn("up", "tween", .9, .6)} src="./Screenshot 2024-02-17 at 7.52.40 AM.png" alt="project" />
        </div>
      </div>
    </motion.section>
  );
